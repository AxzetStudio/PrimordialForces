package studio.axzet.efs.screen.custom;
...
import studio.axzet.efs.screen.ModMenuTypes;

public class ArcadiumInfuserMenu extends AbstractContainerMenu {

    public final ArcadiumInfuserBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ArcadiumInfuserMenu(int containerId, Inventory inventory, FriendlyByteBuf extraData) {
        this(containerId, inventory, inventory.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ArcadiumInfuserMenu(int containerId, Inventory inventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ARCADIUM_INFUSER_MENU.get(), containerId);
        blockEntity = ((ArcadiumInfuserBlockEntity) entity);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.ARCADIUM_INFUSER.get());
    }
