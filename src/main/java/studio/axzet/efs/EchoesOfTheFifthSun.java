...
import studio.axzet.efs.block.client.ArcadiumInfuserBlockEntityRenderer;
import studio.axzet.efs.block.entity.ModBlockEntities;
import studio.axzet.efs.entity.ModEntities;
import studio.axzet.efs.entity.client.*;
import studio.axzet.efs.item.ModArmorMaterials;
import studio.axzet.efs.item.ModCreativeModeTabs;
...
import studio.axzet.efs.screen.custom.ArcadiumInfuserScreen;

// The value here should match an entry in the META-INF/neoforge.mods.toml file
@Mod(EchoesOfTheFifthSun.MOD_ID)
public class EchoesOfTheFifthSun
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "efs";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public EchoesOfTheFifthSun(IEventBus modEventBus, ModContainer modContainer)
    {
